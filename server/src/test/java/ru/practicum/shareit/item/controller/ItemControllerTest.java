...
public class ItemControllerTest {
    ...
    void findAll() throws Exception {
        when(itemService.findAll(anyInt(), anyInt(), anyInt())).thenReturn(List.of(itemResponseDto));
        ...
        verify(itemService, times(1)).findAll(anyInt(), anyInt(), anyInt());
    }
    ...
    void searchItem() throws Exception {
        when(itemService.search(anyString(), anyInt(), anyInt(), anyInt())).thenReturn(List.of(itemResponseDto));

        mockMvc.perform(get("/items/search")
                        .header("X-Sharer-User-Id", "1")
                        .param("text", "ru/practicum/shareit/request/item")
                        .param("from", "0")
                        .param("size", "5")
                        .content(mapper.writeValueAsString(itemDto))
                        .characterEncoding(StandardCharsets.UTF_8)
        ...
        verify(itemService, times(1)).search(anyString(), anyInt(), anyInt(), anyInt());
    }
}
