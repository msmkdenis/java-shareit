...
public interface BookingService {
    ...
    List<BookingResponseDto> findBookingByUser(int userId, String state, int from, int size);

    List<BookingResponseDto> findBookingByOwner(int ownerId, String state, int from, int size);
}
